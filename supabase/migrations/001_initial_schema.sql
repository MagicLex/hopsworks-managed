...
-- Policies (service role has full access, we'll handle auth in the API)
CREATE POLICY "Service role full access users" ON users FOR ALL USING (true);
CREATE POLICY "Service role full access credits" ON user_credits FOR ALL USING (true);
CREATE POLICY "Service role full access usage" ON usage_daily FOR ALL USING (true);
CREATE POLICY "Service role full access billing" ON billing_history FOR ALL USING (true);
CREATE POLICY "Service role full access instances" ON instances FOR ALL USING (true);
CREATE POLICY "Service role full access feature_groups" ON feature_groups FOR ALL USING (true);
CREATE POLICY "Service role full access model_deployments" ON model_deployments FOR ALL USING (true);
